...
export default {
    data() {
        return {
            ...
            coreList: [{
                title: '完善的基础业务构建能力',
                content: '公司拥有完整的制造企业信息化和城市智能化领域的系列产品和解决方案，在激烈的市场竞争和长期服务宝钢的过程中，公司逐步培育、积累、形成了基于钢铁行业的三全服务能力。'
            }, {
                title: '强大的综合集成能力',
                content: '公司拥有强大的系统集成、数据集成能力，可集成几乎所有主流的系统、产品和技术；集信息化、自动化和机电一体化于一身，具备完整的技术链和 QHSEI、CMMI的集成服务能力。'
            }, {
                title: '高效稳定的过程管理能力',
                content: '基于健全、完善的管理体系，如 ISO9001、ISO20000、ISO14001等，公司兼具管理系统化和规范化，拥有很高的运营管控能力和效率。'
            }, {
                title: '新技术、新产品研发与应用能力',
                content: '公司通过云计算、移动互联、大数据、无人化等增量业 务的发展和落地，形成了较完整的技术和运营服务能力；IDC 领域业务稳健增长，云计算业务模式、核心技术和服务能力日趋成熟稳定；新产品研发方面不断取得进展，部分产品突破国外技术 垄断，填补国内空白。'
            }, {
...
@media only screen and (max-width: 768px) {
    ...
    .core-list {
        ...
        li {
            ...
            height: auto;
            background: $white;
            box-shadow: 1px 1px 3px 0 $grey1;
            &:hover {
                box-shadow: initial;
            }
            p {
